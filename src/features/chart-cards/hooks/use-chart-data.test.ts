...
import * as fetchHelper from '@/features/chart-cards/utils/fetch-helper';
import * as getDateRangeUtil from '@/features/chart-cards/utils/get-date-range';
import * as mapChartResponse from '@/features/chart-cards/utils/map-chart-response';
...
vi.mock('@/features/chart-cards/utils/get-date-range');
vi.mock('@/features/chart-cards/utils/map-chart-response');
