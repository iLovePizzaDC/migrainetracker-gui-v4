...
vi.mock('@/features/chart-cards/components/molecules/ChartCard', () => ({
	default: ({ title }: any) => <div data-testid='chart-card'>{title}</div>,
}));
vi.mock('@/features/chart-cards/components/molecules/MidasCard', () => ({
	default: () => <div data-testid='midas-card' />,
}));
vi.mock('@/features/chart-cards/components/molecules/AppendCard', () => ({
