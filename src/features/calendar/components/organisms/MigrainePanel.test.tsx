...
describe('<MigrainePanel />', () => {
  ...
  it('calls useMigrainePanel with date, onClose, disabled and prefilled', () => {
    ...
    render(<MigrainePanel date={mockDate} onClose={mockOnClose} prefilled={prefilled} disabled isOpen />);
  ...
  it('hides actions when areInputsDisabled is true', () => {
    vi.mocked(useMigrainePanel).mockReturnValue({ ...baseHookReturn, areInputsDisabled: true } as any);
