          ...
          >
            {PICKER_HOURS.map((hour, index) => (
              <div
                ...
                className={`h-8 flex items-center justify-center cursor-pointer ${hour === selectedHour ? 'text-white font-medium' : 'text-white/40'
                  }`}
              >
                {hour}
              </div>
          ...
          >
            {PICKER_MINUTES.map((minute, index) => (
              <div
                ...
                className={`h-8 flex items-center justify-center cursor-pointer ${minute === selectedMinute ? 'text-white font-medium' : 'text-white/40'
                  }`}
              >
                {minute}
              </div>
