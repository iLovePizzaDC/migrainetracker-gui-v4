...
describe('<Slider />', () => {
	...
	it('renders label and slider', () => {
		render(<Slider id='slider' label='Slider' min={0} max={10} value={5} onChange={onChange} />);
	...
	it('displays current value in label', () => {
		render(
			<Slider id='slider' label='test label' min={0} max={10} value={3} onChange={onChange} />,
		);
	...
	it('has correct min and max attributes', () => {
		render(<Slider id='slider' label='Slider' min={3} max={7} value={5} onChange={onChange} />);
	...
	it('is disabled if prop is true', () => {
		render(
			<Slider id='slider' label='Slider' min={0} max={10} value={5} onChange={onChange} disabled />,
		);
