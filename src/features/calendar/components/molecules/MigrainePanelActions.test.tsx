...
describe('<MigrainePanelActions />', () => {
  ...
  it('applies success styling to Save on cacheFeedback success', () => {
    ...
    expect(screen.getByRole('button', { name: 'Save' })).toHaveClass('border-green-500/50', 'text-green-800');
  });
  ...
  it('applies error styling to Save on cacheFeedback error', () => {
    ...
    expect(screen.getByRole('button', { name: 'Save' })).toHaveClass('border-red-500/50', 'text-red-800');
  });
  ...
  it('applies success styling to Submit on saveFeedback success', () => {
    ...
    expect(screen.getByRole('button', { name: 'Submit' })).toHaveClass('border-green-500/50', 'text-green-800');
  });
