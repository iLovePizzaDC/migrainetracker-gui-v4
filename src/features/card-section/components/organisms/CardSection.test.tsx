import CardSection from '@/features/card-section/components/organisms/CardSection';
...
import { CARD_TYPES, CHART_TYPES } from '@/features/card-section/constants/card';

vi.mock('@/features/card-section/hooks/use-card-setups');
vi.mock('@/features/card-section/components/molecules/ChartCard', () => ({
	default: ({ title }: any) => <div data-testid='chart-card'>{title}</div>,
}));
vi.mock('@/features/card-section/components/molecules/MidasCard', () => ({
	default: () => <div data-testid='midas-card' />,
}));
vi.mock('@/features/card-section/components/molecules/AppendCard', () => ({
