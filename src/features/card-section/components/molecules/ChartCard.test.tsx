...
vi.mock('@/features/card-section/hooks/use-chart-data', () => ({
	useChartData: vi.fn(() => ({
		isLoading: false,
		areaData: [
			{ name: 'Jan.', value: 12 },
...
vi.mock('@/features/card-section/components/atoms/card/AreaChart', () => ({
	default: () => <div data-testid='area-chart' />,
}));
vi.mock('@/features/card-section/components/atoms/card/PieChart', () => ({
