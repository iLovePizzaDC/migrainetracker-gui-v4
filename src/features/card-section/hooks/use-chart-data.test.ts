import { useChartData } from '@/features/card-section/hooks/use-chart-data';
import * as fetchHelper from '@/features/card-section/utils/fetch-helper';
import * as getDateRangeUtil from '@/features/card-section/utils/get-date-range';
import * as mapChartResponse from '@/features/card-section/utils/map-chart-response';
...
vi.mock('@/features/card-section/utils/fetch-helper');
vi.mock('@/features/card-section/utils/get-date-range');
vi.mock('@/features/card-section/utils/map-chart-response');
